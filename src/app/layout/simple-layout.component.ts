...
@Component({
  ...
  template: `
    <!-- AdminLTE 3.2.0 Layout Structure Simplificado -->
    <div class="wrapper">
      <!-- Navbar -->
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <!-- Test Menu -->
              <li class="nav-item">
                <a [routerLink]="['/test-menu']" class="nav-link" routerLinkActive="active">
...
export class SimpleLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private initializeAdminLTE(): void {
    if (isPlatformBrowser(this.platformId) && typeof $ !== 'undefined') {
      try {
        ...
        console.log('AdminLTE inicializado correctamente');
      } catch (error) {
