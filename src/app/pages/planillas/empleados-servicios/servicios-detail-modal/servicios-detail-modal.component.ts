...
@Component({
  selector: 'app-servicios-detail-modal',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './servicios-detail-modal.component.html',
  styleUrls: ['./servicios-detail-modal.component.scss']
})
export class ServiciosDetailModalComponent implements OnInit, OnDestroy, OnChanges {
