...
export class ContractModalComponent implements OnInit, AfterViewInit {
  ...
  private initializeForm(): void {
    ...
    this.contractForm = this.fb.group({
      ...
      contract_type: ['plazo_fijo', Validators.required],
  ...
  private populateForm(): void {
    ...
    this.contractForm.patchValue({
      ...
      renewal_date: formatDateForInput(this.contract.renewal_date),
      position: this.contract.position_id || this.contract.position?.id || '',
      salary: this.contract.salary,
      salary_scale_id: this.contract.salary_scale_id,
      ...
      has_benefits: this.contract.has_benefits,
      has_bonus: this.contract.has_bonus,
      has_overtime: this.contract.has_overtime,
