...
export class ServiceModalComponent implements OnInit, AfterViewInit {
  ...
  typeOptions = [
    { value: 'servicio_lp', label: 'Servicio Limpieza Pública' },
    { value: 'contrato_lp', label: 'Contrato Administrativo LP' },
  ...
  private initializeForm(): void {
    ...
    this.serviceForm = this.fb.group({
      ...
      contract_type: ['servicio_lp', Validators.required],
