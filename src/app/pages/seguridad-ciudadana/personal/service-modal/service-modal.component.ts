...
export class ServiceModalComponent implements OnInit, AfterViewInit {
  ...
  typeOptions = [
    { value: 'servicio_terceros', label: 'Servicio Terceros' },
    { value: 'contrato_administrativo', label: 'Contrato Administrativo' },
  ...
  private initializeForm(): void {
    ...
    this.serviceForm = this.fb.group({
      ...
      contract_type: ['servicio_terceros', Validators.required],
